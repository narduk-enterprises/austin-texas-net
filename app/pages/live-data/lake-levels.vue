...
<template>
  <SubAppShell title="Lake Levels" :detail-active="!!selectedSpot">
    ...
    <template #panel>
      ...
      <section v-if="selectedSpot" class="animate-fade-up">
        <UButton
          variant="link"
          color="neutral"
          size="xs"
      ...
      <section v-if="!selectedSpot" class="animate-fade-up-delay-1">
        ...
        <div class="space-y-2">
          <UButton
            ...
            variant="ghost"
            color="neutral"
            class="group flex w-full items-center gap-3 rounded-[14px] border border-default bg-default px-3.5 py-3 transition-all duration-200 hover:-translate-y-px hover:border-primary/40 hover:shadow-sm"
